...
const Spiner = () => {
  const icons = [
    ...
    { icon: <SiExpress size={30} className="custom-icon-color" /> },
    ...
    { icon: <SiNextdotjs size={30} className="custom-icon-color" /> },
    { icon: <span className="font-bold text-lg text-yellow-600">JS</span> },
    { icon: <span className="font-bold text-lg text-blue-600">TS</span> },
  ];
  ...
  return (
    <div className="relative flex justify-center items-center my-8 bg-section">
      <div className="relative w-[300px] h-[300px]">
        ...
        {/* Center label */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-slate-500 px-4 py-2  rounded-2xl flex items-center justify-center">
