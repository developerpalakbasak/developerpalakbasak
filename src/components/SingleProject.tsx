...
=======
      <div className={`w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] 2xl:max-w-7xl mx-auto mt-5 py-8 2xl:py-10 px-4 2xl:px-8 bg-card/30 rounded-xl sm:rounded-2xl lg:rounded-3xl 2xl:rounded-3xl flex gap-8 2xl:gap-10 flex-col ${index % 2 === 0 ? "md:flex-row-reverse" : "md:flex-row"}`}>
...
=======
          <div className="text-sm sm:text-base 2xl:text-base space-y-1 2xl:space-y-4">
...
=======
          <div className="flex gap-6 2xl:gap-10 mt-6 2xl:mt-12 text-sm sm:text-base 2xl:text-base font-bold">
>>>>>>> c45f7d51bed25a314f2c5db1b3ddf6d36ec32e20
      {project.liveDemo && (
        <a
