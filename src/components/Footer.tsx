...
const Footer = () => {
  return (
    <div className="w-[95%] md:w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] 2xl:max-w-[1600px] mx-auto mb-5 p-3 sm:p-4 md:p-5 lg:p-6 border border-card-border rounded-3xl flex flex-col justify-center items-center gap-1 bg-card/80">
