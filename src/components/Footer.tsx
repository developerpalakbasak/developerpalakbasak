...
const Footer = () => {
  return (
    <div className="px-2">
      <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] mx-auto mb-5 p-2 sm:p-4 md:p-5 lg:p-6 border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl flex flex-col justify-center items-center gap-1 bg-card/80 shadow-sm">
