  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-3">
        ...
        <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl text-center font-bold">
      ...
      <div className="flex justify-center gap-12 w-full mt-10 py-3 px-4">
        <a
          ...
          className="hover:scale-110 transition-transform text-primary inline-block origin-center"
          title="Send an Email"
        >
        ...
        <a
          ...
          className="hover:scale-110 transition-transform text-green-500 inline-block origin-center"
      ...
      <div className="w-full max-w-2xl mx-auto mt-10 p-1 rounded-xl sm:rounded-2xl lg:rounded-3xl">
        <div className="border border-card-border bg-card/50 backdrop-blur-sm px-4 sm:px-6 py-4 sm:py-6 rounded-xl sm:rounded-2xl lg:rounded-3xl flex flex-col gap-2 sm:gap-3">
          {contactInfo.map((item) => (
            <div
              key={item.title}
              className="flex items-center text-sm sm:text-base border-b pb-2 sm:pb-4 border-card-border last:border-b-0 last:pb-0"
            >
