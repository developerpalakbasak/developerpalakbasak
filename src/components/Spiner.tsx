  ...
  return (
    <div className="relative flex justify-center items-center py-10">
      <div className="relative w-[350px] h-[350px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px]">
        ...
        {/* Ambient Corner Glows: Enhances visual depth */}
        <div className="absolute w-full h-full pointer-events-none">
          <div className="absolute -top-10 -left-10 w-40 h-40 rounded-full bg-blue-500 blur-[80px] opacity-10" />
          <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-emerald-500 blur-[80px] opacity-10" />
          <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-pink-500 blur-[80px] opacity-10" />
          <div className="absolute -bottom-10 -right-10 w-40 h-40 rounded-full bg-yellow-500 blur-[80px] opacity-10" />
        </div>
