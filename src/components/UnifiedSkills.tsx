...
const UnifiedSkills = () => {
  ...
  return (
    <section className="w-full max-w-6xl lg:max-w-7xl xl:max-w-6xl mx-auto p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 py-8 sm:py-12 md:py-16 bg-card border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl relative overflow-hidden shadow-sm">
