...
const UnifiedSkills = () => {
  ...
  return (
    <section className="w-[95%] md:w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] 2xl:max-w-[1600px] mx-auto mt-10 py-4 sm:py-2 lg:py-4 p-4 sm:p-2 lg:p-2 bg-card/80 backdrop-blur-xl border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl relative overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-primary/10">
      ...
      <div className="p-4 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex justify-center order-1 lg:order-2 py-10 sm:py-0">
          <div className="relative w-full max-w-[280px] sm:max-w-[400px] aspect-square flex items-center justify-center">
            ...
            {/* Rotating Outer Ring: Pure CSS animation */}
