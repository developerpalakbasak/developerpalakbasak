...
const Hero = () => {
  ...
  return (
    <div
      className="w-full p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 py-8 sm:py-12 md:py-16 bg-card border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl flex gap-4 sm:gap-8 md:gap-12 flex-col md:flex-row items-center shadow-sm relative"
    ...
    >
      ...
      <div className="min-w-full lg:min-w-1/2 flex flex-col justify-center relative z-10 px-6">
        ...
        <div>
          <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl font-black mt-1 leading-tight">
          ...
          <div className="relative mt-2">
            ...
            <span className="flex md:ml-6">
              <Typewriter
                quotes={quotes}
                className={
                  "text-base sm:text-3xl md:text-4xl lg:text-3xl text-primary font-black uppercase tracking-widest"
                }
              />
            </span>
          </div>
          ...
          <div className="flex gap-3 flex-wrap justify-center w-full min-w-0">
            {socialLinks.map((item, index) => (
              <a
                ...
                className="p-2 sm:p-3 border-2 border-primary text-primary rounded-full transition-all duration-300 hover:scale-110"
          ...
          <div className="flex gap-3 flex-wrap justify-center md:justify-start w-full min-w-0">
            {skillsIcon.map((item, index) => (
              <div
                key={index}
                title={item.name}
                className={`p-1 flex justify-center items-center rounded-xl sm:rounded-2xl ${item.bg} ${item.text} h-11 w-11 hover:scale-125 transition-all duration-300 cursor-help shadow-lg shrink-0`}
              >
