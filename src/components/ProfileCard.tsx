...
export default function ProfileCard() {
  return (
    <section className="w-full flex flex-col items-center gap-10">
      ...
      <div className="w-full p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 py-8 sm:py-12 md:py-16 bg-card border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl flex flex-col items-center gap-2 sm:gap-4 overflow-hidden shadow-sm relative">
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-2 sm:gap-8">
          ...
          <div className="hidden md:flex w-full md:w-2/5 items-center justify-center scale-[0.4] sm:scale-75 md:scale-80 lg:scale-90 xl:scale-100 h-[180px] sm:h-auto">
          ...
          <div className="w-full md:w-3/5 flex p-2 sm:p-4 md:pr-20 md:pl-10 flex-col items-center md:items-start text-center md:text-left gap-4 relative z-10">
            <div className="w-full space-y-4 flex flex-col items-center md:items-start md:pl-10">


              {/* Identity Title with high-contrast gradient text */}
              <h1 className="text-xl sm:text-4xl lg:text-4xl xl:text-5xl font-black tracking-tighter text-gradient drop-shadow-md py-1 whitespace-nowrap">
                Palak Basak
              </h1>
              ...
              <div className="space-y-3 sm:space-y-4 w-full pt-2">
                <p className="text-xs sm:text-lg lg:text-xl font-black text-foreground/80 tracking-widest uppercase pl-2">
                  Fullstack Software Engineer @ <span className="text-primary">ThetaSofts</span>
                </p>
                <div className="flex flex-wrap gap-1.5 sm:gap-2 pl-2">
                  ...
                  <span className="text-[9px] sm:text-xs font-bold uppercase tracking-widest px-2.5 py-1 rounded-full bg-slate-500/10 text-slate-700 dark:text-slate-300 border border-slate-500/20">iOS</span>
