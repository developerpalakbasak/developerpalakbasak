...
export default function ProfileCard() {
  return (
    <section className="w-full flex flex-col items-center gap-10">
      ...
      <div className="w-full p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 py-8 sm:py-12 md:py-16 2xl:py-24 bg-card border border-card-border rounded-xl sm:rounded-2xl lg:rounded-3xl 2xl:rounded-[2.5rem] flex flex-col items-center gap-2 sm:gap-4 2xl:gap-8 overflow-hidden shadow-sm relative">
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-2 sm:gap-8">
          ...
          <div className="hidden md:flex w-full md:w-2/5 items-center justify-center scale-[0.4] sm:scale-75 md:scale-80 lg:scale-90 xl:scale-100 2xl:scale-[1.35] h-[180px] sm:h-auto">
