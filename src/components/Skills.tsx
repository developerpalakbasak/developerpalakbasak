...
const Skills = () => {
  ...
  return (
    <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] mx-auto bg-card border border-card-border p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 py-3 md:py-4 lg:py-5 rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-sm">
        <div>
