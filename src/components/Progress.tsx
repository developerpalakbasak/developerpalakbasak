          ...
          <div key={index} className="flex items-center gap-3 p-2 cursor-pointer">
            <div className="flex flex-col gap-2">
              <span className="flex gap-3">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">{item.title}</p>
              </span>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground">{item.subtitle}</p>
            </div>
          </div>
        ))}
    </section>
