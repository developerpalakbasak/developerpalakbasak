  ...
  return (
    <div className="page-fade-in">
      <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10 2xl:gap-10 p-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 py-1 pb-12">
        ...
        <div className="bg-card border border-card-border p-4 sm:p-6 md:p-6 lg:p-8 xl:p-10 2xl:p-8 py-4 sm:py-12 md:py-16 2xl:py-10 rounded-xl sm:rounded-2xl lg:rounded-3xl 2xl:rounded-3xl space-y-6 shadow-sm">
          <p className="text-sm sm:text-base lg:text-lg 2xl:text-lg leading-relaxed">
          ...
          <div className="pt-4 border-t border-card-border">
            <p className="text-base sm:text-lg lg:text-xl 2xl:text-xl leading-relaxed italic text-primary font-bold">
