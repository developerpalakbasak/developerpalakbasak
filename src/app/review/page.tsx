...
const ReviewPage = () => {
  return (
    <div className="page-fade-in">
      <div className="w-full md:w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] 2xl:max-w-[1560px] mx-auto flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10 p-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 py-1 pb-20">
        {/* Header Section: Standardized across all top-level pages */}
        <div className="pt-8 sm:pt-12 md:pt-16">
          <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl font-bold mb-4 sm:mb-6 italic border-b-4 border-primary inline-block text-center text-gradient">
            Client Reviews
          </h1>
          ...
          {reviews.map((review) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8 italic">
                  "{review.message}"
                </p>
              </div>
        ...
        <div className="mt-16 sm:mt-24 text-center">
          <div className="p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl lg:rounded-3xl bg-card border border-card-border relative overflow-hidden shadow-sm">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent pointer-events-none" />
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-4">Ready to start your next project?</h3>
