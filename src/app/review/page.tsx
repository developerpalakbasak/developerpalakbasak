...
const ReviewPage = () => {
  return (
    <div className="page-fade-in">
      <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-6xl mx-auto flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10 p-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 py-1 pb-20">
